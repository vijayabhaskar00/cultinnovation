  ...
  {   
     ...
     success: function(msg)
     {
        ...
        else if(msg.result == 0 && msg.error_code == 100)
        {
        	 ...
        	 $('.welcome_login').hide();
        	 $('.confirm_login').show();
        	 $('#confirm_email').val(email_verify.email);
        	 login_user("user_name",email_verify.email);
        }
     ...
     {        
        ...
        else if(msg.result == 0 && msg.error_code == 100)
        {
        	 ...
        	 // do login 
        	 	$('.welcome_login').hide();
        	 	$('.confirm_login').show();
        	 	$('#confirm_email').val(mobile_verify.mobile);
        	 	login_user("mobile",mobile_verify.mobile);
        }
...
$('.forgot_password_link').click(function(event)
{
	...
	forgotEmailObj.mobile_email = selected_way;
	...
	$.ajax({
       ...
       {        
       		...
       		if(msg.result == 1)               
            {
               ...
               event.preventDefault();
               $('.otp_details').empty();
			         $('.otp_details').append("Your OTP was successfully sent to  \" "+selected_way+" \" ");
			         $('.confirm_login').hide();
